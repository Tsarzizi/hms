# backend/app/routes/inpatient_total_revenue_route.py
...
from backend.app.features.hospital_revenue.inpatient_total_revenue.inpatient_total_revenue_service import (
    get_dep_doc_map,
    get_full_revenue,
)
from backend.app.shared.validators import parse_date_generic
from backend.app.shared.cache import cache_get, cache_set
